...
foreach(_cmake_expected_target IN ITEMS opencv_world opencv_img_hash opencv_sfm correspondence multiview numeric simple_pipeline)
...
set_target_properties(correspondence PROPERTIES
  INTERFACE_LINK_LIBRARIES "/usr/lib/x86_64-linux-gnu/libglog.so;\$<LINK_ONLY:multiview>;\$<LINK_ONLY:opencv_world>;Eigen3::Eigen"
)
...
set_target_properties(multiview PROPERTIES
  INTERFACE_LINK_LIBRARIES "/usr/lib/x86_64-linux-gnu/libglog.so;\$<LINK_ONLY:numeric>;Eigen3::Eigen;\$<LINK_ONLY:ceres>"
)
